export const assetsObj = {
    ...
    login_error_empty: {
        ...
        fi: 'Syötä käyttäjänimi ja salasana.',
    },
    login_error_wrong: {
    ...
    filtering_all_columns: {
        en: 'All columns',
        fi: 'Kaikki sarakkeet',
    },
    filtering_some_columns: {
        en: 'Some columns',
        fi: 'Jotkut sarakkeet',
    },
    match_case: {
    ...
    delete_many_users_confirmation: {
        en: 'Are you sure you want to delete these users? This cannot be undone. Users:',
        fi: 'Oleto varma, että haluat poistaa nämä käyttäjät? Tätä toimintoa ei voi perua. Käyttäjät:',
    },
    cancel: {
        en: 'Cancel',
        fi: 'Peruuta',
